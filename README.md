...
- **You Are Here**（城市地标，562 杯 + 172 挂饰；意大利等市场仍在出新）
...
| 🎄 停产款默认隐藏 | 圣诞/季节限定等 155 款、以及已停产的 **Global Icon 系列 448 款默认不显示**——这些基本收不到，算进完成度只会让分母永远差一截。点筛选栏对应标签即可纳入，统计分母同步变化 |
...
231 项无头检查，覆盖筛选、中英切换、图鉴分页、账号、收藏、照片、导入导出、
